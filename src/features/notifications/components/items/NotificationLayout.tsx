...
export const NotificationLayout = ({
  ...
  const containerClasses =
    variant === "dropdown"
      ? "flex cursor-pointer items-start gap-3 text-start transition-all select-none focus:outline-none w-full px-4 py-3 hover:bg-neutral-50 dark:hover:bg-neutral-800/40 rounded-lg"
