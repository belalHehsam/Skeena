    ...
    return (
      <>
        <section className="bg-card overflow-hidden rounded-2xl border border-neutral-200 shadow-sm dark:border-neutral-800">
          <div className="group/cover from-primary-950 via-primary-700 to-primary-400 relative h-40 overflow-hidden bg-linear-to-br sm:h-52">
            {user.coverPhoto ? (
              <img
                src={user.coverPhoto}
                alt={t("coverAlt", {
              ...
              <div
                aria-hidden="true"
                className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(255,255,255,0.22),transparent_28%),radial-gradient(circle_at_80%_35%,rgba(255,255,255,0.14),transparent_24%),linear-gradient(135deg,transparent_20%,rgba(255,255,255,0.08)_50%,transparent_80%)] opacity-80"
              />
            )}
            ...
            {isOwnProfile && (
              <>
                ...
                <Button
                  ...
                  className="absolute inset-e-3 top-3 rounded-full bg-white/90 text-neutral-800 opacity-100 shadow-sm backdrop-blur transition-opacity hover:bg-white sm:opacity-0 sm:group-hover/cover:opacity-100 dark:bg-neutral-950/85 dark:text-neutral-100 dark:hover:bg-neutral-950"
                >
          ...
          <div className="relative px-4 pb-6 sm:px-6 sm:pb-7">
            <div className="grid grid-cols-1 gap-x-4 sm:grid-cols-[minmax(0,1fr)_auto]">
              ...
              <div className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-neutral-500 sm:col-span-2 sm:row-start-3 dark:text-neutral-400">
                ...
                {(isOwnProfile || !user.isPrivate) && user.createdAt && (
                  <span className="inline-flex items-center gap-1">
              ...
              {(isOwnProfile || !user.isPrivate) && user.bio && (
                <p className="mt-3 max-w-2xl text-start text-sm leading-6 whitespace-pre-wrap text-neutral-700 sm:col-span-2 sm:row-start-4 dark:text-neutral-300">
                  {user.bio}
                </p>
              )}
