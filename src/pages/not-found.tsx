...
const NotFound = () => {
    return (
        <main className="majlis-page-pattern relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-10">
            ...
            <section className="relative w-full max-w-[520px] rounded-2xl border border-neutral-200 bg-white/90 p-7 text-center shadow-sm backdrop-blur dark:border-neutral-800 dark:bg-neutral-900/90">
                ...
                <h1 className="font-heading text-3xl font-bold text-neutral-900 dark:text-neutral-50">
                    This page is not part of the Majlis yet.
                </h1>
