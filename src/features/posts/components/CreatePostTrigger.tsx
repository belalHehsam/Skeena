...
import { ImageIcon, SmilePlus, Video } from "lucide-react";
export default function CreatePostTrigger() {
  ...
  return (
    <div>
      <Dialog>
        <div className="bg-card border-border flex w-full flex-col rounded-xl border p-4 shadow-sm">
        ...
        <DialogContent className="rounded-xl sm:max-w-[526px]">
          <CreatePostForm post={""} />
        </DialogContent>
      </Dialog>
    </div>
